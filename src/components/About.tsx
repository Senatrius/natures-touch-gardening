...
export const About = () => {
  return (
    <section className='mx-auto my-[3.75rem] flex w-[93%] max-w-[80rem] flex-col items-stretch justify-between gap-12 md:my-[6.25rem] md:w-[88%] md:flex-row md:gap-20 lg:w-[83%]'>
